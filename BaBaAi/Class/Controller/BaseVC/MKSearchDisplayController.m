...
//  NewLingYou
//
//  Created by Seven on 15/5/23.
//  Copyright (c) 2015年 Seven. All rights reserved.
//

#import "MKSearchDisplayController.h"

@implementation MKSearchDisplayController
...
- (id)initWithSearchBar:(UISearchBar *)searchBar contentsController:(UIViewController *)viewController
{
    ...
    if (self) {
        ...
        self.searchResultsTitle = NSLocalizedString(@"搜索结果", @"The search results");
    }
    return self;
}
